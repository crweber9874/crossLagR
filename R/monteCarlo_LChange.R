...
monteCarloLChange <- function(
  ...
  if(dgp == "riclpm") {
    ...
    # Similar structure for confounder data
    # Include confounder parameters in simulation_parameters
    # Use simCLPMu for data generation
    # Same model fitting approach
  }
