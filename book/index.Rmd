--- 
title: "Dynamic Panels and the Cross Lagged Panel Model"
author: "Christopher Weber, Stanley Feldman, Adam Panish, and Bang Zheng"
date: "`r Sys.Date()`"
...
* An outline
* An empirical example using the The Institute for the Study of Citizens and Politics (ISCAP) Panel examining the relationship between political legitimacy and partisanship from 2012-2020.
