...
3. **Sensitivity and Identification.** How far a reported CLPM estimate can lie from the RI-CLPM truth once a degree of trait variance and trait correlation is assumed --- the bias function, where it peaks, and the tipping point at which a reported cross-lag is fully accounted for by trait confounding.
