...
In the presence of confounding variables, $Z$, that influence both $x$ and $y$, the cross-lagged estimates may be biased, in both the CLPM or the RI-CLPM. A confounder, like all variables in a panel design may be *time-varying* or *time-invariant*; characteristics that fluctuate over time, partially or fully explaining the pattern of relationships between $x$ and $y$, or stable characteristics that do not change over time, but also explain the joint relationship between $x$ and $y$.

If confounder $Z$ is time-invariant, we may respecify the CLPM or RI-CLPM as follows:
...
If the confounder is time varying, then:
...
When the confounder is "unobserved" and either time-invariant or time-varying, we might ask: What is the consequence of ignoring that confounder in the CLPM or RI-CLPM? There is some disagreement in the literature on this question.
