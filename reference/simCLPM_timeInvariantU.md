...
Simulate data from a cross-lagged panel model (CLPM) with a
...
- confounder_p:
  ...
  The effect of the time-invariant confounder on x variables.

- confounder_q:

  The effect of the time-invariant confounder on y variables.

- confounder_variance:

  The variance of the time-invariant confounder.
