...
Monte Carlo simulation for Random Intercept Cross-Lagged Panel Model
This function combines the estimation and simulation of an RI-CLPM over
a fixed number of trials. The output is a data frame that includes the
